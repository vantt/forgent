...
| 05 | Live proof và rollout | `code:implement` | planned | multi-cell/live resume/direct smoke xanh; `npm test` final integrated proof, chờ CẢ P00-P03 và P04 đã merge. **Full-suite gate.** |
...
| P05 | planned | — | — | unblocked: P00-P03 and P04 are now merged; next step is live proof/final rollout |
