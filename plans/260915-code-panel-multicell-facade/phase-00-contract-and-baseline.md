...
- có plan/phase path hoặc yêu cầu rõ “run/resume this implementation plan” -> `planned-multi-cell`;
- concrete code change không có plan track -> `direct-single-cell`;
- input mơ hồ không được âm thầm đoán một file plan.
