...
Status: in-progress (Phase 01 done) | Created: 2026-08-31 | Owner: maintainer
...
| 3 | [Harness seam + two proofs](phase-03-harness-seam-and-two-proofs.md) | 2 | planned | Proof 1 and Proof 2 recorded under `verification/`; `--contract` CLI door; negative tests green |
