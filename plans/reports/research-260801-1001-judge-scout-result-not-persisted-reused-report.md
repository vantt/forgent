...
| tsk-4y8 | done | Fix hand-back path fgos-planning khi gặp gap CONTEXT.md giữa decompose | Khác cơ chế — đây là session người thật (fgos-planning), không phải judgeDiscovery/judgeDecompose mechanical call. Không đụng scout/judge-executor |
...
| tsk-4xr | todo / clarify | fgos-exploring re-scout giữa hội thoại khi câu trả lời người hé lộ fact mới — sibling item của tsk-62d (nêu trong description tsk-62d), nhưng là re-scout trong session người thật, KHÔNG phải persist/reuse output của judge mechanical call. Không cùng vấn đề |
