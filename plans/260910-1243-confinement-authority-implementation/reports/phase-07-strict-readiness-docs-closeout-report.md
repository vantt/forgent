...
| M-1 (P04) | P04 | CLOSED — `CHANGELOG.md`'s R7 bullet previously overclaimed that all 7 canonical capabilities got an explicit `unconfined` declaration; only 3 (`advise`, `code:review`, `code:debug`) actually do | Corrected in `CHANGELOG.md:39` at commit `fbff7630`; see §6 below. |
