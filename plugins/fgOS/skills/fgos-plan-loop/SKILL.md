...
2. **Compose `open.json`** dispatching the fixture's required first pass
   ...
   ```json
   {
     ...
     "actors": [
       { "id": "doer", "executor": "codex-cli", "tier": "standard" },
       { "id": "reviewer", "executor": "claude", "tier": "analytical" },
       { "id": "red-team", "executor": "agy-cli", "tier": "analytical" }
     ],
     "steps": [
       {
         "type": "operation",
...
```json
{
  ...
  "protocolRef": { "id": "core.coordination-protocol.standalone-master-coordination-loop" },
  "actors": [
    { "id": "fixer", "executor": "codex-cli", "tier": "standard" },
    { "id": "reviewer", "executor": "claude", "tier": "analytical" },
    { "id": "red-team", "executor": "agy-cli", "tier": "analytical" }
  ],
  "steps": [
