...
- [Team Dispatch V1](team-dispatch-v1/README.md) records Steps 00–06 from baseline
  design through Work-attached adoption.
- Step 07 and Step 08 remain in `proposals/` until their architecture is accepted
  and an implementation roadmap is approved.
