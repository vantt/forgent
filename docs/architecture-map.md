...
**Phiên bản:** v0.3. **Trạng thái:** CHUẨN — chấp nhận 2026-07-16, record
...
**Changelog v0.2 → v0.3** (record [0012](decisions/0012-typed-edge-model-supersedes-deps-parent-separation.md) — supersede 0002, chi tiết ở §11):
