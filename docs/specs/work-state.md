...
- Nội dung tổng hợp thật của Compound-learn (phán/kỹ năng tổng hợp capture thành bài học hoặc tài liệu người-dùng cuối, phân loại Diataxis) chưa tồn tại — `fgos compound` hôm nay chỉ chuyển stage, không tự sinh bản ghi tổng hợp nào; lớp nội dung đó là slice sau của compound-learn-enduser-docs (chưa build, per D4-D8 compound-learn-enduser-docs).
