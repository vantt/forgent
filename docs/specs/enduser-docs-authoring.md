...
- Kỷ luật soạn: kỹ năng `fgos-compounding` (cả hai gốc `repo/.claude/skills/fgos-workflow/` và
  `repo/.agents/skills/fgos-workflow/`), Flow bước 1-5 — gom capture, phân ngăn, lưu tag+móc, gom
