...
- Lời gọi phán-đoán bên dưới engine (quyết đủ-rõ/chưa-đủ-rõ) có thể trả về văn bản không máy-đọc-được thay vì phán quyết đúng khuôn khi được gọi TỪ BÊN TRONG một phiên trợ lý khác đang chạy (lồng phiên) — engine fail-safe đúng thiết kế (đậu cổng chờ-người, không bao giờ coi không chắc là pass), nhưng kết quả là một item khách quan rõ ràng vẫn bị hỏi oan khi chạy trong hoàn cảnh lồng phiên này; nguyên nhân gốc (phía lời gọi con trả văn xuôi thay vì JSON) và một cách phán bền hơn cho hoàn cảnh lồng phiên chưa được sửa — tái hiện được thủ công, chứng minh 2026-07-20 qua case-study P50 Phase 3, filed `docs/backlog.md` STR68.
