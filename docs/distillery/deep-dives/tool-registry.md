...
4. **Sửa prose 3 skill** (fgos-planning, fgos-validating, fgos-executing) + CLAUDE.md — thay hardcode "GitNexus" bằng capability lookup, theo đúng 3-nấc symphony:
