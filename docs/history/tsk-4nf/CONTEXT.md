...
| D-ID | Quyết định |
|------|-----------|
| D1 | Nội dung trích từ bằng chứng thực nghiệm đã có sẵn ở `docs/history/tsk-580/plan.md` (phần "Verify cho tsk-580 — sửa lại tại fgos-validating") và `docs/history/tsk-580/iron-law-evidence.md` — không tự phát minh ví dụ mới, dùng lại đúng transcript thật đã chạy. |
