...
("Audit fgos-planning, fgos-validating, and fgos-code-implement SKILL.md
...
Captured live during `fgos-validating`'s own reality gate, before any of
the 3 rules were added (real transcript, this session):

```
$ grep -q "capacity-dispatch-fallback.md" .claude/skills/fgos-planning/SKILL.md; echo "fgos-planning: $?"
fgos-planning: 1
```
