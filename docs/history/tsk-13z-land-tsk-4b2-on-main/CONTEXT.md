...
| D2 | The item's own `verify` command is correct and runnable as stated — confirmed via `fgos-researching`'s round 1 (`docs/history/tsk-13z-land-tsk-4b2-on-main/RESEARCH.md`): `git merge-base --is-ancestor 7add82b8 main && npm test`. No change needed. |
