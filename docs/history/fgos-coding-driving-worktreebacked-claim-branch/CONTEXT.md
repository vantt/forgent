...
None — scope, files, and behavior are fully locked (D1, D2). Exact prose wording of the two edited sections is `fgos-planning`/`fgos-code-implement`'s job, not decided here.
