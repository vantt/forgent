...
**An toàn:** worker không nhận credential ghi state, không chạy trong repo chính (worktree). Mọi nhánh worker có prefix nhận diện; xóa nhánh = hủy đề xuất, log không đổi.
