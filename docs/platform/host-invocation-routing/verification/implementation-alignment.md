...
| Two-stage authority. | `current partial` | [../../../../packages/host-runtime/rust/src/authority_gate.rs](../../../../packages/host-runtime/rust/src/authority_gate.rs), [../../../../packages/host-runtime/rust/src/invocation_service.rs](../../../../packages/host-runtime/rust/src/invocation_service.rs) | Current proof is in Rust host-runtime tests; future external provider authority tests remain for R2. |
| `legacy-cli` bypasses semantic kernel and execs Node payload directly. | `current partial` | [../../../../apps/fgos/src/main.rs](../../../../apps/fgos/src/main.rs), [../../../../apps/fgos/src/legacy_exec.rs](../../../../apps/fgos/src/legacy_exec.rs), [../../../../apps/fgos/tests/cli_tests.rs](../../../../apps/fgos/tests/cli_tests.rs) | Installed release packaging proof still belongs to R1/packaging. |
...
| External process provider protocol. | `planned` | [../contracts/component-protocol.md](../contracts/component-protocol.md) | P7 conformance proof. |
| Static external manifest discovery without execution. | `planned` | [../contracts/external-provider-manifest.md](../contracts/external-provider-manifest.md) | P7 manifest proof. |
| Native `version` as `distribution.build.show`. | `current partial` | [../../../../packages/host-runtime/contracts/command-routes.json](../../../../packages/host-runtime/contracts/command-routes.json), [../../../../apps/fgos/src/cli_projector.rs](../../../../apps/fgos/src/cli_projector.rs), [../../../../packages/distribution/rust/src/lib.rs](../../../../packages/distribution/rust/src/lib.rs), [../../../../apps/fgos/tests/cli_tests.rs](../../../../apps/fgos/tests/cli_tests.rs), `cargo test -p fgos-host-runtime -p fgos --quiet` | Targeted Rust tests passed on 2026-09-14; installed-default release proof still open. |
| Production remote peer route. | `planned` | [r3-remote-peer-proof.md](r3-remote-peer-proof.md) | P8 route proof. |
...
| Preview/stable and compatibility-window duration. | `unknown` | [../architecture/release-boundaries.md](../architecture/release-boundaries.md#2-open-release-decisions) | Product/release decision in packaging stream. |
