...
| R2 | External process preview: framed protocol, supervision, fixture conformance, static manifest validation, derived cache by fingerprint. | Core replacement, signatures/marketplace, WASM. |
