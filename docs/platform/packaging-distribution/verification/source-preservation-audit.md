...
| Current code may implement legacy behavior even after target architecture supersedes it. | `runtime-identity-and-activation.md`, `migration-map.md`, `docs/specs/distribution.md` | `README.md` section 3; `verification/implementation-alignment.md` | preserved | Maintain explicit legacy/deprecated status for compatibility behavior such as `fgos setup`. |
