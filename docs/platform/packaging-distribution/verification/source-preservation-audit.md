...
| `AGENTS.md` is the portable instruction projection; Claude/Gemini/Codex-specific files are adapters when host features require them. | Current design discussion | `contracts/instruction-composition-and-projection.md`; `verification/implementation-alignment.md` | preserved partial | P3 instruction source registry and P4 effective-set composition are implemented; effective-set renderer and stale projection checks remain planned in P5. |
