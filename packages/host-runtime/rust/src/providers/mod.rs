...
pub use external_process::{
    ...
    frame_codec, supervisor, adapter, CodecError, ExternalProcessConfig, ExternalProcessOutcome,
    ExternalProcessProviderAdapter, ExternalProcessRequest, ExternalProcessSupervisor, FrameCodec,
    FrameMessage, JsonRpcError, JsonRpcNotification, JsonRpcRequest, JsonRpcResponse, RequestId,
    COMPONENT_PROTOCOL_VERSION, DEFAULT_MAX_FRAME_SIZE, FIXTURE_OPERATION_ID,
    FIXTURE_OUTCOME_CONTRACT, FIXTURE_PROCESS_DESCRIPTOR, FIXTURE_PROVIDER_ID,
