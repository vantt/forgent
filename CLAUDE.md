...
This project is indexed by GitNexus as **forgent** (8390 symbols, 12749 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
