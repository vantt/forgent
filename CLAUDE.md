...
This project is indexed by GitNexus as **forgent** (8409 symbols, 12768 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
