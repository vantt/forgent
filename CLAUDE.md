...
This project is indexed by GitNexus as **forgent** (6425 symbols, 10162 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
