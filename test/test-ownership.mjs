...
export const MANIFEST = [
  ...
  { id: 'intake-plan', status: 'shadow', pattern: 'src/intake/plan.mjs', directTests: ['test/intake/plan.test.mjs'], boundaryTests: [] },
  { id: 'intake-plan-verdict-from-plan-md', status: 'shadow', pattern: 'src/intake/plan-verdict-from-plan-md.mjs', directTests: ['test/intake/plan-verdict-from-plan-md.test.mjs'], boundaryTests: [] },
  // No direct test file exists for these two; each has real boundary
  // coverage located by grep, not guessed.
  { id: 'intake-risk-keywords', status: 'shadow', pattern: 'src/intake/risk-keywords.mjs', directTests: [], boundaryTests: ['test/evolve/iron-law.test.mjs'] },
  { id: 'intake-verify-pattern-check', status: 'shadow', pattern: 'src/intake/verify-pattern-check.mjs', directTests: [], boundaryTests: ['test/intake/plan.test.mjs', 'test/state/discover-verdict-override.test.mjs', 'test/intake/judge-verify-second-pass-stability.test.mjs'] },
  ...
  { id: 'state-cleanup-pool', status: 'shadow', pattern: 'src/state/cleanup-pool.mjs', directTests: ['test/state/cleanup-pool.test.mjs'], boundaryTests: [] },
  { id: 'state-cursor', status: 'shadow', pattern: 'src/state/cursor.mjs', directTests: ['test/state/cursor.test.mjs'], boundaryTests: [] },
  { id: 'state-dep-graph', status: 'shadow', pattern: 'src/state/dep-graph.mjs', directTests: ['test/state/dep-graph.test.mjs'], boundaryTests: [] },
  { id: 'state-discover-pool', status: 'shadow', pattern: 'src/state/discover-pool.mjs', directTests: ['test/state/discover-pool.test.mjs'], boundaryTests: [] },
  { id: 'state-drift-status', status: 'shadow', pattern: 'src/state/drift-status.mjs', directTests: ['test/state/drift-status.test.mjs'], boundaryTests: [] },
  { id: 'state-handoff', status: 'shadow', pattern: 'src/state/handoff.mjs', directTests: ['test/state/handoff.test.mjs'], boundaryTests: [] },
  { id: 'state-plan-pool', status: 'shadow', pattern: 'src/state/plan-pool.mjs', directTests: ['test/state/plan-pool.test.mjs'], boundaryTests: [] },
  { id: 'state-porting', status: 'shadow', pattern: 'src/state/porting.mjs', directTests: ['test/state/porting.test.mjs'], boundaryTests: [] },
  { id: 'state-porting-store', status: 'shadow', pattern: 'src/state/porting-store.mjs', directTests: ['test/state/porting-store.test.mjs'], boundaryTests: [] },
  { id: 'state-postland-drift', status: 'shadow', pattern: 'src/state/postland-drift.mjs', directTests: ['test/state/postland-drift.test.mjs'], boundaryTests: [] },
  { id: 'state-priority-formula', status: 'shadow', pattern: 'src/state/priority-formula.mjs', directTests: ['test/state/priority-formula.test.mjs'], boundaryTests: [] },
  { id: 'state-retro-pool', status: 'shadow', pattern: 'src/state/retro-pool.mjs', directTests: ['test/state/retro-pool.test.mjs'], boundaryTests: [] },
  { id: 'state-retrospective-doors', status: 'shadow', pattern: 'src/state/retrospective-doors.mjs', directTests: ['test/state/retrospective-doors.test.mjs'], boundaryTests: [] },
