  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        cwd: { type: 'string', description: 'Worker/session working directory for "run"/"show"/"launch-master-loop"/"chain" (R7); distinct from --dir (the main checkout root). Omitted defaults to the resolved repo root, byte-identical to before this flag existed.' },
      },
      positional: ['sub', 'id'],
      required: ['sub'],
    },
