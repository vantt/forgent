  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        json: { type: 'boolean', description: '"show" only: accepted as a no-op -- the envelope is always JSON.' },
      },
      positional: ['sub', 'id'],
      required: ['sub'],
    },
