...
export const COMMAND_REGISTRY = [
  ...
  {
    name: 'coordination',
    invoke: 'fgos coordination <run|show|close|launch-master-loop|chain|recover>',
    ...
    parameters: {
      type: 'object',
      properties: {
        sub: { type: 'string', description: 'Sub-verb (positional).', enum: ['run', 'show', 'close', 'launch-master-loop', 'chain', 'recover'] },
