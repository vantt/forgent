  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        executor: { type: 'string', description: '"run" only: global trusted executor id, applied to every dispatch unless a per-actor "actors[].executor" override is declared in the request file.' },
        model: { type: 'string', description: '"run" only: global trusted model id -- kind:"agent-led" requests only; refused for kind:"declared-protocol" (no engine policy channel today).' },
        tier: { type: 'string', description: '"run" only: global trusted minimum tier, applied to every dispatch unless a per-actor "actors[].tier" override is declared in the request file.' },
