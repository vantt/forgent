...
This project is indexed by GitNexus as **forgent** (2214 symbols, 2768 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
