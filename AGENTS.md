...
This project is indexed by GitNexus as **forgent** (3371 symbols, 6043 relationships, 238 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
