...
This project is indexed by GitNexus as **forgent** (366 symbols, 807 relationships, 30 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
