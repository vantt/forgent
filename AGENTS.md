...
This project is indexed by GitNexus as **forgent** (10991 symbols, 15962 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
