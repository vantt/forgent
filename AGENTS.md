...
This project is indexed by GitNexus as **forgent** (7130 symbols, 11119 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
