...
This project is indexed by GitNexus as **forgent** (7530 symbols, 11697 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
