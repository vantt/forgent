...
This project is indexed by GitNexus as **forgent** (1502 symbols, 3491 relationships, 123 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
