...
This project is indexed by GitNexus as **forgent** (11620 symbols, 16622 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
