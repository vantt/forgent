...
This project is indexed by GitNexus as **forgent** (4796 symbols, 7993 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
